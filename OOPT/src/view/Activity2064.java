...
public class Activity2064 extends JTabbedPane {
	...
	public Activity2064(JTree tree, ArrayList<TestCase> ptc, Datainfo data) {
		...
		this.addTab("Performance Test Environment", null, splitPane, null);
		...
		this.addTab("Performance Test Result", null, splitPane_1, null);
		...
		button.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent arg0) {
				...
				data.setText(27, textPane.getText());
	...
	private void setTextPane(ArrayList<StageText> st) {
		textPane.setText(st.get(27).getText());
	}
