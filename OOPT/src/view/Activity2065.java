...
public class Activity2065 extends JTabbedPane {
	...
	public Activity2065(JTree tree, ArrayList<TestCase> atc, Datainfo data) {
		...
		this.addTab("Acceptance Test Environment", null, splitPane, null);
		...
		this.addTab("Acceptance Test Result", null, splitPane_1, null);
		...
		button.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent arg0) {
				...
				data.setText(28, textPane.getText());
	...
	private void setTextPane(ArrayList<StageText> st) {
		textPane.setText(st.get(28).getText());
	}
